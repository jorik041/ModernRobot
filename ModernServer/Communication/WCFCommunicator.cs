...
namespace ModernServer.Communication
{
    public class WCFCommunicator : IWCFCommunicator, IDisposable
    {
        ...
        private readonly IStrategy[] _avaliableStrategies = { new FortsBasic(), new FortsBasicInv(), new FortsMultiplied(), new FortsMultipliedInv(), new SimpleTrend(), new SimpleTrendInv() };
