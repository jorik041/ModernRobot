...
namespace Calculator.Helpers
{
    public static class MathHelper
    {
        ...
        public static float LeastSquaresValueAtX(Point[] points, float x)
        {
        ...
        private static float SlopeOfPoints(Point[] points)
        {
        ...
        private static float YInterceptOfPoints(Point[] points, float slope)
        {
            float xBar = points.Average(p => p.X);
            float yBar = points.Average(p => p.Y);
