...
namespace ServerTests
{
    ...
    public class ServerTests
    {
        ...
        public void PassStrategies()
        {
            ...
            {
                pool.AddNewOrderForCalculation("SI", new DateTime(2015, 1, 1), new DateTime(2015, 6, 1), TimePeriods.Hour, new float[] { 10, 5, 50, 1, 8}, 0, false);
                pool.ProcessOrders();
                ...
                pool.AddNewOrderForCalculation("SI", new DateTime(2015, 1, 1), new DateTime(2015, 6, 1), TimePeriods.FifteenMinutes, new float[] { 10, 5, 50, 1, 8 }, 0, false);
                pool.ProcessOrders();
                ...
                pool.AddNewOrderForCalculation("SI", new DateTime(2015, 1, 1), new DateTime(2015, 6, 1), TimePeriods.Minute, new float[] { 10, 5, 50, 1, 8 }, 0, false);
                pool.ProcessOrders();
